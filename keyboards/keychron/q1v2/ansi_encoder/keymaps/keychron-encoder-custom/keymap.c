...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_main_layer] = LAYOUT_ansi_82(
        ...
        LT(_extras_layer, KC_ESC),  MT(MOD_LGUI, KC_A),     MT(MOD_LALT, KC_S),     MT(MOD_LSFT, KC_D),     MT(MOD_LCTL, KC_F),     KC_G,     KC_H,     MT(MOD_RCTL, KC_J),     MT(MOD_RSFT, KC_K),     MT(MOD_RALT, KC_L),     MT(MOD_RGUI, KC_SCLN),  KC_QUOT,              KC_ENT,             KC_PGDN,
